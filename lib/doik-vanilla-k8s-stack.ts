...
export class DoikVanillaK8SStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const masterNodeIntanceType = ec2.InstanceType.of(ec2.InstanceClass.T4G, ec2.InstanceSize.LARGE);
    const workerNodeInstanceType = ec2.InstanceType.of(ec2.InstanceClass.T4G, ec2.InstanceSize.MEDIUM);
    ...
    const latestAmiId = ec2.MachineImage.fromSsmParameter('/aws/service/canonical/ubuntu/eks-pro/22.04/1.29/stable/20240426/arm64/hvm/ebs-gp2/ami-id');
